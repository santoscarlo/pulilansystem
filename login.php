...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php" class="col-12 p-0 m-0">
      <p style="text-transform: full-width;font-weight: bolder;text-decoration-line: line-through;color: black;text-shadow: 0px 0px 5px black;" class="col-12">Pulilan Bulacan</p>
      <p class="text-sm p-0 m-0">Municipality Of Pulilan Bulacan.</p>
    </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
